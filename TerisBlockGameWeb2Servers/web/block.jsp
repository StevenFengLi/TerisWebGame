...
<%
    ...
    String user = (String) request.getAttribute("msg2");
...
<head>
    ...
    <style>
        ...
        #manual{ margin:0 auto;padding:5px 15px 0px 25px;color:#FFF;font-size:10px;}
        ...
        body
        {
            align:center;
            valign:center;
            padding:50px 1000px 50px 400px;
            width:950px;
            margin:0 auto;
        }
    </style>
    ...
    <div>
        ...
        <div id="manual">
            <ul>
                ...
                <li>↓ 加速向下</li>
                <li>空格 变换</li>
                <li><font color="red" size="1"> ${msg3 }</font></li>
            </ul>
        </div>
    </div>
</div>
